...
type Subpart = { Id: SubpartId; Classes: Class list }
...
module Subpart =
    ...
    let classes (s: Subpart) = s.Classes
...
module Config =
    ...
    let subparts (c: Config) = c.Subparts
...
module Course =
    ...
    let configurations (c: Course) = c.Configurations
